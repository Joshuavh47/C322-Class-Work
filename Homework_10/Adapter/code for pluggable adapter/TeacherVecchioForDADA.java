public class TeacherVecchioForDADA implements TeachingDADA {

    public void defenseAgainstCruciatusCurse(){
        System.out.println( 
             "This curse inflicts extreme pain. The overall effect "
           + "of the curse depends on the state of the mind of the "
           + "caster and how intent the caster is on inflicting "
           + "torture. "
        );
        System.out.println( 
           ...
           + "miniature glass spinning top that emits shrill sounds "
           + "if when someone with evil intent is in the vicinity. "
        );
    }
    ...
    public void defenseAgainstPetrification(){
        System.out.println( 
             "Petrification turns a living being into a stone-like state "
           + "of unconsciousness. " 
        );
        System.out.println( 
